...
// would otherwise report the proxy's values instead of the real client's.
...
// `verify` stashes the raw bytes on req.rawBody - Meta's WhatsApp webhook
// signature (X-Hub-Signature-256) is an HMAC over the exact raw body, which
// is lost once Express parses it into req.body.
